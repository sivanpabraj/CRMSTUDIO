...
describe('snapshot-sanitize', () => {
  ...
  it('merges local auth material after pull but never restores legacy SMS credentials', () => {
    const remote = {
    ...
    expect(merged.studioInfo.smsApiKey).toBeUndefined()
    expect(merged.studioInfo.smsUsername).toBeUndefined()
