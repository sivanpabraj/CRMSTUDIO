    ...
    return `<div class="sm-card sm-settings-full">
      ...
      <div class="sm-card-body">
        <p style="font-size:.82rem;color:var(--sm-text-muted);line-height:1.7;margin:0 0 16px">
          چیدمان پیشخوان بر اساس اولویت تصمیم‌گیری استودیو ثابت شده تا مقایسه دوره‌ها و محل شاخص‌ها تغییر نکند. تمام کارت‌ها مستقیماً از قراردادها، حسابداری، هزینه‌ها، تقویم و گردش تولید خوانده می‌شوند. صفحهٔ اول تختهٔ کاری امروز است: تأیید نوبت، آفیش تیم، تحویل و ظرفیت آزاد. جزئیات مالی مدیر زیر همان صفحه جمع شده است.
        </p>
        <div class="sm-widget-list">
          ${[
            ['fa-sun', 'عملیات امروز', 'مراسم، نوبت، پیگیری قابل‌اقدام و ظرفیت تیم'],
            ['fa-user-check', 'آفیش از روی پیشخوان', 'ساعت، عکاس و فیلمبردار همان روز'],
            ['fa-coins', 'شاخص‌های مالی جمع‌وجور', 'فقط مدیر سیستم و مدیر استودیو'],
