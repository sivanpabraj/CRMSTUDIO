    ...
    return `<div class="sm-card sm-settings-full">
      ...
      <div class="sm-card-body">
        <p style="font-size:.82rem;color:var(--sm-text-muted);line-height:1.7;margin:0 0 16px">
          چیدمان پیشخوان بر اساس اولویت تصمیم‌گیری استودیو ثابت شده تا مقایسه دوره‌ها و محل شاخص‌ها تغییر نکند. تمام کارت‌ها مستقیماً از قراردادها، حسابداری، هزینه‌ها، تقویم و گردش تولید خوانده می‌شوند. بالای صفحه، عملیات امروز استودیو است: مراسم، پیگیری، ظرفیت آزاد تیم و عملکرد.
        </p>
        <div class="sm-widget-list">
          ${[
            ['fa-sun', 'عملیات امروز', 'مراسم، نوبت، پیگیری و ظرفیت تیم'],
