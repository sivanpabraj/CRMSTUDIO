...
هیچ استقرار مستقیمی از شاخه‌های کاری مجاز نیست. خروجی نسخهٔ جاری فقط از tag دقیق `v1.1.0` ساخته می‌شود. Workflow انتشار artifact، SBOM و SHA-256 تولید می‌کند؛ deploy به staging/production باید مرحله‌ای جدا و نیازمند تأیید انسانی باشد.
